...
/**
 * this icon will be included in @material-ui/icons v5
 * src: https://github.dev/mui-org/material-ui/blob/c19e8f41129a4a9214aa9d2672bffdaac9b0bdee/packages/material-ui-icons/lib/BadgeOutlined.js
 */
const RolesIcon = createSvgIcon(
  <>
